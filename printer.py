...
if __name__ == '__main__':
    ...
    p.font_b_on()
    p.print_text('00:00:00 <@agmlego> Hello world!\n')
    p.print_text('00:00:01 ')
    p.inverse_on()
    p.print_text('<@agmlego> Hello i3ircterm!\n')
    p.inverse_off()
    p.print_text('00:00:15 <@agmlego> I ')
    p.bold_on()
    p.print_text('love')
    p.bold_off()
    p.print_text(' that this printer does stuff onboard for you.\n')
    p.linefeed()
    p.linefeed()
    p.linefeed()
